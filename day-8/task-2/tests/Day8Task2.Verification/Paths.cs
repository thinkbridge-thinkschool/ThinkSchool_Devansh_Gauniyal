...
internal static class Paths
{
    ...
    // tests/Day8Task2.Verification/bin/...) to find the day-8/task-2 root,
    ...
    public static string FindTaskRoot()
    {
        ...
        throw new DirectoryNotFoundException("Could not locate the day-8/task-2 root from the test assembly location.");
    }
}
