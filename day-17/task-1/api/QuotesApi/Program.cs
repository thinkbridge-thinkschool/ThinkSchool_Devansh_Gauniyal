...
if (!builder.Environment.IsEnvironment("Testing")
    ...
    && !string.IsNullOrWhiteSpace(builder.Configuration["KeyVault:Name"]))
{
    ...
    .AddPolicyScheme(
        ...
        options =>
        {
            options.ForwardDefaultSelector = context =>
            {
                ...
                var entraIssuers = entra.ValidateAndGetIssuers();
...
builder.Services
    ...
    .Configure<EntraOptions>((options, entra) =>
    {
        ...
        {
            ValidateIssuer = true,
            ValidIssuers = entra.ValidateAndGetIssuers(),
            ValidateAudience = true,
