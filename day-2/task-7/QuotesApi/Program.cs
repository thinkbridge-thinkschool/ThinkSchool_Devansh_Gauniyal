    ...
    CancellationToken cancellationToken) =>
{
    ...
    var response = await refreshTokenService.IssueForLoginAsync(
        user,
        cancellationToken);
    ...
    CancellationToken cancellationToken) =>
{
    if (!string.IsNullOrWhiteSpace(request.RefreshToken))
    {
        await refreshTokenService.RevokeForLogoutAsync(
            request.RefreshToken,
            cancellationToken);
    }
