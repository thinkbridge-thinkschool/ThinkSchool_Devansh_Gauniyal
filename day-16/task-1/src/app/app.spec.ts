...
describe('App', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [App],
      // provideRouter() added alongside app.routes.ts: App now renders a
      // <router-outlet /> (see app.html), and RouterOutlet injects Router at
      // construction time, so it must be resolvable even though none of the tests
      // below navigate anywhere.
